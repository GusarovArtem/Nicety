...
import ua.nicety.database.entity.AuthProvider;
...
import ua.nicety.security.auth2.user.OAuth2UserInfo;
import ua.nicety.security.auth2.user.OAuth2UserInfoFactory;
